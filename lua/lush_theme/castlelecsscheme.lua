...
local theme = lush(function(injected_functions)
   ...
   return {
      ...
      lualine_a_normal                           { bg=colors.pink, fg="#080808", }, -- lualine_a_normal xxx guifg=#080808 guibg=#d183e8
      ...
      Search                                     { bg=colors.search, }, -- Search         xxx guibg=#adadad
      ...
      Normal                                     { bg=colors.bg, fg=colors.white, }, -- Normal         xxx guifg=#dedede guibg=#272b34
      ...
      Todo                                       { gui="bold,underline", fg=colors.yellow }, -- Todo           xxx cterm=bold,underline gui=bold,underline guifg=#feffad
      ...
      Boolean                                    { fg=colors.pink, }, -- Boolean        xxx guifg=#ff66b0
      ...
      PreProc                                    { gui="bold", fg=colors.purple, }, -- PreProc        xxx cterm=bold gui=bold guifg=#beadfa
      ...
      Typedef                                    { Define, }, -- Typedef        xxx guifg=#3dcfff
      ...
      Special                                    { fg=colors.yellow, }, -- Special        xxx guifg=#feffad
